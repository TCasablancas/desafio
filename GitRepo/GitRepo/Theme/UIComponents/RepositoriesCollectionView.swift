...
//        
//        let item = repository[indexPath.item]
...
//        if let cell = collectionView.cellForItem(at: indexPath) as? RepositoriesCollectionViewCell {
//            cell.backgroundColor = Theme.default.gray
//            self.repositorySelected = self.repository[item]
//        }
//        
//        collectionView.dataSource = self
//        collectionView.delegate = self
